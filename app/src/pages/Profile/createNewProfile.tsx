...
import { Modal, Button, Form, Checkbox, Col, Divider, Input, InputNumber, Row, Select } from 'antd';
            ...
            <Row>
                ...
                <Col span={10}>
                    <Form.Item name={['payment', 'credit']} rules={[{ required: true }]}>
                        <Input.Password placeholder="Credit Card" onChange={(e) => {
                ...
                <Col span={10}>
                    <Form.Item name={['payment', 'cvc']} rules={[{ required: true, min: 0, max: 999 }]}>
                        <Input placeholder="CVC" onChange={(e) => {
