                    ...
                    <Row>
                        <Col span={12}>
                            ...
                            <Form.Item name={['shipping', 'phone']} label="Phone" rules={[{ required: true }]}>
                                <Input placeholder="ex:5142223333" type="number" />
                            </Form.Item>
                            <br />
                        ...
                        <Col span={10}>
                            <Form.Item name={['payment', 'month']} label="Exp Month" rules={[{ required: true }]}>
                                <Select placeholder="Select an option" allowClear options={monthOptions}></Select>
                            </Form.Item>
                        ...
                        <Col span={10}>
                            <Form.Item name={['payment', 'year']} label="Exp Year" rules={[{ required: true }]}>
                                <Select placeholder="Select an option" allowClear options={yearOptions}></Select>
                            </Form.Item>
                        </Col>
                    </Row>
                </Form>
