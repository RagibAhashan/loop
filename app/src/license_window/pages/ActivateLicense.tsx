...
import { ACCESS_GRANTED, GET_SYSTEM_ID, SERVER_ENDPOINT } from '../../common/Constants';
            ...
            <Spin spinning={loading}>
                <div style={{ backgroundColor: '#212427', height: '100vh', padding: '5%' }}>
                    <Form onFinish={getID} style={{ width: '50%' }}>
                        ...
                        <Button type="primary" style={{ width: '1000px' }} danger onClick={() => window.ElectronBridge.send(ACCESS_GRANTED)}>
                            Bypass
                        </Button>
                    </Form>
                </div>
