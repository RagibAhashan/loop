// This part of code was extracted from the walmart client side javascript code after some debugging.
// e : credit card number (string)
// t : ccv (string)
// r : boolean for encryption format (true by default)
// PIE is an object that can be requested from https://securedataweb.walmart.com/pie/v1/wmcom_us_vtg_pie/getkey.js?bust=(timestamp)
// The pie object should look like this for the moment, if not changed by walmart
/* {
    PIE.L = int;
    PIE.E = int;
    PIE.K = string;
...
// This function returns an array like the following :
// [encNumber, encCCV, integrityCheck]: [string, string, string]
...
var EncryptWalmart = function (e, t, r, PIE) {
    ...
    for (m = 0; m < d.length; ++m) y[m] = parseInt(d.substr(m, 1), 10);
    var g = o.convertRadix(y, d.length, 10, E, 62);
    o.bnMultiply(g, 62, 131072), o.bnMultiply(g, 62, 65536), o.bnAdd(g, 62, v), 1 == PIE.phase && o.bnAdd(g, 62, 4294967296);
    var O = '';
    for (m = 0; m < E; ++m) O += n.base62.substr(g[m], 1);
    (f = a.substr(0, PIE.L) + O.substr(0, E - 4) + a.substring(a.length - PIE.E)), (p = O.substring(E - 4));
    return [f, p, n.integrity(PIE.K, f, p)];
};
var n = {};
(n.base10 = '0123456789'),
    ...
    (n.fixluhn = function (e, t, r) {
        ...
        return (
            a < r ? (a += 10 - r) : (a -= r),
            0 != a ? ((a = (e.length - t) % 2 != 0 ? 10 - a : a % 2 == 0 ? 5 - a / 2 : (9 - a) / 2 + 5), e.substr(0, t) + a + e.substr(t + 1)) : e
        );
    }),
...
(i.MSBnotZero = function (e) {
    ...
    (i.compute = function (e, t) {
        ...
        for (var o = 0; o < t.length; )
            (n[(o >> 2) & 3] ^= (255 & t.charCodeAt(o)) << (8 * (3 - (3 & o)))), 0 == (15 & ++o) && o < t.length && (n = e.encrypt(n));
        return (
            (0 != o && 0 == (15 & o)) ||
                ((a = r[0]), i.leftShift(r), i.MSBnotZero(a) && (r[3] ^= i.const_Rb), (n[(o >> 2) & 3] ^= 128 << (8 * (3 - (3 & o))))),
            (n[0] ^= r[0]),
            (n[1] ^= r[1]),
            (n[2] ^= r[2]),
            (n[3] ^= r[3]),
...
var o = {
    ...
    F: function (e, t, n, r, a, i, c, u, s) {
        ...
        p[p.length - s - 1] = t;
        for (var m = o.convertRadix(r, a, u, s, 256), E = 0; E < s; E++) p[p.length - s + E] = m[E];
        var b,
            h = o.cbcmacq(c, p, p.length, e),
            _ = h,
            v = new Array(2 * d);
        for (f = 0; f < d; ++f)
            f > 0 &&
                0 == (3 & f) &&
                ((b = (f >> 2) & 255), (b |= (b << 8) | (b << 16) | (b << 24)), (_ = e.encrypt([h[0] ^ b, h[1] ^ b, h[2] ^ b, h[3] ^ b]))),
                (v[2 * f] = _[3 & f] >>> 16),
                (v[2 * f + 1] = 65535 & _[3 & f]);
    ...
    ValToDigit: function (e, t) {
        ...
        else for (n = 0; n < e.length; n++) r += o.alphabet[e[n]];
        return r;
    },
    encryptWithCipher: function (e, t, n, r) {
        ...
        for (var l = 0; l < 5; l++) {
            var f,
                p = o.F(n, 2 * l, t, d, d.length, s.length, c, r, u);
            f = 0;
