...
//                 log('Getting session resp %O', resp);
...
//             const itemDesc = this.htmlParser.parseJSONById('item', '__NEXT_DATA__');
//             log('Parsed item description %O', itemDesc);
...
//                 log('Add to Cart response %O', resp);
//                 if (resp.headers['set-cookie']) {
//                     await this.cookieJar.saveInSessionFromArray(resp.headers['set-cookie']);
//                 }
...
//                 log('Checking cart response %O', resp);
