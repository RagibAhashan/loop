...
(function () {
    ...
    (function (root, fnDefine) {
        ...
        //         _.R = function (b) {
        //             "\v" == "v" ||
        //             document.documentElement.style.scrollbar3dLightColor !=
        //                 undefined
        //                 ? setTimeout(b, 0)
        ...
        //         //             var B = dfGetPlug();
        //         //             E.plugins = padString(
        //         //                 calculateMd5_b64(B.obj),
        //         //                 s.plugins
        //         //             );
        //         //             E.nrOfPlugins = padString(
        //         //                 String(B.nr),
        //         //                 s.nrOfPlugins
        //         //             );
        //         //         } catch (u) {
        ...
        //         //             ? padString(
        //         //                   calculateMd5_b64(navigator.cpuClass),
        //         //                   s.cpuClass
        //         //               )
        //         //             : padString("", s.cpuClass);
        //         //         E.platform = navigator.platform
        //         //             ? padString(
        //         //                   calculateMd5_b64(navigator.platform),
        //         //                   s.platform
        //         //               )
        //         //             : padString("", s.platform);
        //         //         E.doNotTrack = navigator.doNotTrack
        //         //             ? padString(
        //         //                   calculateMd5_b64(navigator.doNotTrack),
        //         //                   s.doNotTrack
        //         //               )
        //         //             : padString("", s.doNotTrack);
        //         //         E.jsFonts = padString(
        //         //             calculateMd5_b64(getJsFonts()),
        //         //             s.jsFonts
        //         //         );
        //         //         E.webglFp = padString(
        //         //             calculateMd5_b64(getWebglFp()),
        //         //             s.webglFp
        //         //         );
        //         //         var A = 0,
        //         //             i;
        ...
        //         //                         for (var y in w) {
        //         //                             if (
        //         //                                 "browser cpu device engine os".indexOf(
        //         //                                     y
        //         //                                 ) !== -1 &&
        //         //                                 w[y].length % 2 === 0
        //         //                             ) {
        ...
        //         //         }
        //         //         i.isGecko =
        //         //             /Gecko/i.test(d) && /Gecko\s*\/\s*\d/i.test(e);
        ...
        //         //             : null;
        //         //         i.isSafari =
        //         //             /Safari\s*\/\s*\d/i.test(e) && /Apple/i.test(c);
        //         //         i.isChrome = /Chrome\s*\/\s*(\d[\d\.]*)/i.test(e);
        //         //         i.verChrome = i.isChrome
        //         //             ? i.formatNum(RegExp.$1)
        //         //             : null;
        //         //         i.isOpera = /Opera\s*[\/]?\s*(\d+\.?\d*)/i.test(e);
        //         //         i.verOpera =
        //         //             i.isOpera &&
        //         //             (/Version\s*\/\s*(\d+\.?\d*)/i.test(e) || 1)
        //         //                 ? parseFloat(RegExp.$1, 10)
        //         //                 : null;
        ...
        //         //                 !(
        //         //                     q.isGecko &&
        //         //                     q.compareNums(q.verGecko, "1,5,0,0") < 0
        //         //                 )
        //         //             ) {
        //         //                 q.setStyle(
        //         //                     h.firstChild,
        //         //                     g.concat(["display", "inline"])
        //         //                 );
        //         //             }
        //         //             return {
        //         //                 span: h,
        ...
        //         //             if (!a.isIE) {
        //         //                 c = a.findNavPlugin(
        //         //                     "Shockwave\\s*for\\s*Director"
        //         //                 );
        //         //                 if (
        //         //                     c &&
        //         //                     c.description &&
        //         //                     a.hasMimeType(b.mimeType)
        //         //                 ) {
        ...
        //         //             if (
        //         //                 e.compare(
        //         //                     b.slice(0, Math.min(d[0].length, b.length)),
        //         //                     d[0]
        //         //                 ) != 0
        //         //             ) {
        //         //                 return g;
        ...
        EncryptedForm.prototype = {
            ...
            validate: function () {
                ...
                return (
                    this.encryption.validate(fields) || {
                        valid: false,
                    }
                );
            },
    ...
    //             return adyen.encrypt.createEncryptedForm(
    //                 form,
    //                 key,
    //                 options || {}
    //             );
